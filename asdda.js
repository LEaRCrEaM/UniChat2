    ...
    <div class="contents">
        <div class="content" data-content="Tank">
            ...
            <div class='hack-group'>
              ...
              <h class="extra">Speed:</h>
              <input type="range" min="0" max="100" class="slider-input" value="1">
        ...
        <div class="content" data-content="Turret">
            ...
            <div class='hack-group'>
                ...
                <input type="range" min="0" max="720" class="slider-input" value="12">
...
document.addEventListener('keydown', (e) => {
    if (e.ctrlKey && e.key == 'm') {
        e.preventDefault();
        if (isAllowed) {
          document.querySelector('#main').style.display = document.querySelector('.gui2').style.display == 'block' ? 'none' : 'block';
        } else {
