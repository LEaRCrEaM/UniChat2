...
// Function to convert HSL to RGB decimal value (like 16711680)
function hslToRgbDecimal(h, s, l) {
    s /= 100;
    l /= 100;
    ...
    return (r << 16) + (g << 8) + b; // Convert to decimal
}

// Initial setup
espColor = 16711680; // Start color in decimal form
let hue = 0; // Starting hue (0 is red)

// Interval to gradually change color
var espInterval = setInterval(() => {
    hue = (hue + 1) % 360; // Cycle through hues 0-359
    espColor = hslToRgbDecimal(hue, 100, 50);
}); // Update every 100ms
...
var o = CanvasRenderingContext2D.prototype.fillText;
var o2 = CanvasRenderingContext2D.prototype.strokeText;
CanvasRenderingContext2D.prototype.fillText = function() {
    this.fillStyle = decimalToRGB(espColor);
    return o.apply(this, arguments);
};
CanvasRenderingContext2D.prototype.strokeText = function() {
    this.strokeStyle = decimalToRGB(espColor);
    return o.apply(this, arguments);
};
