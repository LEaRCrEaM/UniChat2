    ...
    function findDetails() {
        if (!User.name) {
            if (t = document.querySelector('.UserInfoContainerStyle-userNameRank.UserInfoContainerStyle-textDecoration')) {
                ...
                if ((User.name.length > 2) && ([/*'Midway', 'Queen.of.Spain', 'Arpecu9_KunuT_Bo_MHe', 'DerMar'*//*, 'Who_Boss', 'POLYANASMEHA', '0_0_PBX_2.0', '30P', 'NewAguero', 'Shot.Of.Liquor_43', 'NertZ''Lend',*/ 'Luciana', 'Zeppelin', 'GoneGhost', /*'FeD-K9', */'DeIay', 'Queen.exe', 'ThinkTwice', 'ArmadiIlo', 'A.n.n.y', 'Nanny', 'ioi', 'Queen.of-Spain', 'ici', 'F.15', 'Minnie', 'Lucii', 'ARMEN2008SUPER_best', 'Pullout', 'F.20', 'F.11', 'Long', 'SmiIe', 'Smile', 'F.18'].includes(User.name))) {
